...
[Joe Sawada](http://www.socs.uoguelph.ca/~sawada/), an expert on combinatorial generation, maintains [debruijnsequence.org](https://debruijnsequence.org), a superlative resource on de Bruijn sequence and universal cycle construction. Check out [debruijnsequence.org/db/cutdown](https://debruijnsequence.org/db/cutdown) for an accessible introduction to $P^{(K)}_L$-sequences and other cut-down de Bruijn sequences as well as a performant implementation of our algorithm in C.
